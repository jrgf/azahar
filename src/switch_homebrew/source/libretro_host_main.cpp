...
constexpr const char* LibretroBuildMarker = "switch-libretro-deko-global-settings-v46";
#else
constexpr const char* LibretroBuildMarker = "switch-libretro-gl-hw-restore-v46";
#endif
